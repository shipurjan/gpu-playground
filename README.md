...
This is a hands-on learning repository where I'm teaching myself GPU computing from scratch using [Claude Code](https://claude.com/claude-code). I ask questions about GPU concepts, CUDA syntax, and parallel programming patterns, and document the answers directly in the source code comments for future reference.
